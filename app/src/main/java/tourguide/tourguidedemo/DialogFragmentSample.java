...
public class DialogFragmentSample extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final ImageButton busbutton = (ImageButton) view.findViewById(R.id.bus);
//
...
//                .playOn(busbutton);
        ...
        closebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTutorialHandler.setToolTip(toolTip).playOn(button);
            }
        });
        ...
        busbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mTutorialHandler.cleanUp();
                mTutorialHandler.setToolTip(toolTip2).playOn(closebutton);
            }
        });
